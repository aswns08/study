...
import com.daejeon.mybatis.bbs.dao.BBSDao;
...
public class BBSServiceImpl implements BBSService{
	...
	public HashMap<String, Object> list(String pageNum) {
		...
		if (count > 0) {
			...
			articleList = bbsDao.getArticles(hashmap);
	...
	public BoardVO content(int article_Num) {
		...
		return bbsDao.content(article_Num);
	...
	public BoardVO getUpdateForm(int article_Num) {
		...
		return bbsDao.getUpdateForm(article_Num);
	}
