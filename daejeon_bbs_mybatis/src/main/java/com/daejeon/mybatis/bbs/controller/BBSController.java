package com.daejeon.mybatis.bbs.controller;
...
import com.daejeon.mybatis.bbs.service.BBSService;
...
public class BBSController {
	...
	public ModelAndView content(@RequestParam int article_Num, String pageNum) {
		...
		article = bs.content(article_Num);
	...
	public String update(@ModelAttribute BoardVO article, String pageNum,
			MultipartFile springfname) {
		
		bs.update(article, springfname);
		
		return "redirect:/content.daejeon?article_Num="+article.getArticle_Num()+"&pageNum="+pageNum;
	}
