...
public class FoodMainFileListMapVO {
	...
	public void setF_mileage(int f_mileage) {
	...
	public String toString() {
		return "FoodMainFileListMapVO [f_num=" + f_num + ", f_name=" + f_name
				...
				+ ", f_mileage=" + f_mileage + ", saveFileName=" + saveFileName
				+ "]";
	}
}
