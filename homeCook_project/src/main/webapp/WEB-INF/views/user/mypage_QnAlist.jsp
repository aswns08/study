    ...
    <div class="container">
        ...
        <div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-sm-9 col-md-10 main">
					<c:if test="${loginUser.user_Level==0}">
							<h2 class="sub-header">나의Q&A</h2>
					</c:if>
					<c:if test="${loginUser.user_Level==1}">
							<h2 class="sub-header">나의식당의 모든 Q&A</h2>
					</c:if>
					<c:if test="${loginUser.user_Level==2}">
							<h2 class="sub-header">모든Q&A</h2>
					</c:if>
									...
									<tr>
										...
										<td>
											...
											<c:if test="${qnaVO.q_Dept == 0}">
												...
												<a href="MyQNAContent.app?q_Num=${qnaVO.q_Num}&f_num=${qnaVO.f_Num}">${qnaVO.q_Title}</a>
										</td>
										<td>${qnaVO.id}</td>
										<td>${qnaVO.q_Date}</td>
									</tr>
