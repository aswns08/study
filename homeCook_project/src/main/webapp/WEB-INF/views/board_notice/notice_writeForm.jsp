        ...
        <div class="row row-offcanvas row-offcanvas-left">
			...
			<div>
				...
				<input type="hidden" name="pageNum" id="pageNum" value="${pageNum}">
					...
					<div class="form-group">
						<a href="NoticeList.app"><input type="button" class="btn btn-default col-sm-1" value="취소"></a>
						<input type="button" class="btn btn-primary col-sm-1" id="noticeWriteBtn" value="글쓰기">			
					</div>		
